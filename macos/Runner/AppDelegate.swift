...
class AppDelegate: FlutterAppDelegate {
  ...
  override func applicationDidFinishLaunching(_ notification: Notification) {
    ...
    NSLog("✅ AppDelegate DID FINISH LAUNCHING - LUCIDCLIP")


    guard let controller = mainFlutterWindow?.contentViewController as? FlutterViewController else {
      NSLog("❌ mainFlutterWindow FlutterViewController not ready")
      return
    }

    // IMPORTANT: ensure plugins are registered (keep this)
    ...
    NSLog("✅ lucidclip/frontmost_app channel registered")
  }
}
