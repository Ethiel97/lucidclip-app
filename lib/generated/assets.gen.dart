...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/icon.ico
  String get iconIco => 'assets/icons/icon.ico';
...
class Assets {
  ...
  static const String envStaging = 'env.staging.json';

  /// List of all assets
  static List<String> get values => [envDev, envProd, envStaging];
}
