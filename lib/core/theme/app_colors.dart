...
abstract class AppColors {
  ...
  static const surfaceElevated = Color(0xFF1E1F22);
  ...
  /// Borders / strokes
  static const borderSubtle = Color(0xFF2A2B30);
  ...
  static const MaterialColor purpleSwatch =
      MaterialColor(0xFF615FFF, <int, Color>{
        50: Color(0xFFF5F3FF),
  ...
  static const MaterialColor surfaceSwatch =
      MaterialColor(0xFF101118, <int, Color>{
        50: Color(0xFFF5F5F7),
  ...
  static const MaterialColor bgSwatch = MaterialColor(0xFF050509, <int, Color>{
    50: Color(0xFFF5F5F7),
